...
namespace OnyxScheduling.Data.Migrations
{
    ...
    [Migration("20240514174313_adjustModels")]
            ...
            modelBuilder.Entity("OnyxScheduling.Models.Invoices", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateTime = new DateTime(2024, 5, 14, 13, 43, 13, 219, DateTimeKind.Local).AddTicks(3673),
                            FinishedDateTime = new DateTime(2024, 5, 14, 13, 43, 13, 219, DateTimeKind.Local).AddTicks(3715),
                        ...
                        new
                        {
                            ...
                            Assigned_Customer_Id = "01c84c0a-84f1-4504-94ba-ce28a4c99245",
                            Assigned_Technician_Id = "2",
                            CreatedDateTime = new DateTime(2024, 5, 14, 13, 43, 13, 219, DateTimeKind.Local).AddTicks(3721),
                            FinishedDateTime = new DateTime(2024, 5, 14, 13, 43, 13, 219, DateTimeKind.Local).AddTicks(3722),
