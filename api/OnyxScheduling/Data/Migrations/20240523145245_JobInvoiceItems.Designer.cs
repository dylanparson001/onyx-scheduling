...
namespace OnyxScheduling.Data.Migrations
{
    ...
    [Migration("20240523145245_JobInvoiceItems")]
    partial class JobInvoiceItems
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OnyxScheduling.Models.Invoices", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateTime = new DateTime(2024, 5, 23, 10, 52, 45, 829, DateTimeKind.Local).AddTicks(562),
                            FinishedDateTime = new DateTime(2024, 5, 23, 10, 52, 45, 829, DateTimeKind.Local).AddTicks(604),
                            InvoiceId = 0,
                        ...
                        new
                        {
                            ...
                            Assigned_Customer_Id = "01c84c0a-84f1-4504-94ba-ce28a4c99245",
                            Assigned_Technician_Id = "2",
                            CreatedDateTime = new DateTime(2024, 5, 23, 10, 52, 45, 829, DateTimeKind.Local).AddTicks(609),
                            FinishedDateTime = new DateTime(2024, 5, 23, 10, 52, 45, 829, DateTimeKind.Local).AddTicks(610),
                            InvoiceId = 0,
