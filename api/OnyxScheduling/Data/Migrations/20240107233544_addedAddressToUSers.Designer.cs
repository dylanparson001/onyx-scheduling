...
namespace OnyxScheduling.Data.Migrations
{
    ...
    [Migration("20240107233544_addedAddressToUSers")]
    partial class addedAddressToUSers
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OnyxScheduling.Models.Invoices", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateTime = new DateTime(2024, 1, 7, 18, 35, 44, 411, DateTimeKind.Local).AddTicks(6478),
                            FinishedDateTime = new DateTime(2024, 1, 7, 18, 35, 44, 411, DateTimeKind.Local).AddTicks(6527),
                            InvoiceId = 0,
                        ...
                        new
                        {
                            ...
                            Assigned_Customer_Id = "01c84c0a-84f1-4504-94ba-ce28a4c99245",
                            Assigned_Technician_Id = "2",
                            CreatedDateTime = new DateTime(2024, 1, 7, 18, 35, 44, 411, DateTimeKind.Local).AddTicks(6531),
                            FinishedDateTime = new DateTime(2024, 1, 7, 18, 35, 44, 411, DateTimeKind.Local).AddTicks(6533),
                            InvoiceId = 0,
