...
namespace OnyxScheduling.Data.Migrations
{
    ...
    [Migration("20240530174639_AddDefaultQuantity")]
    partial class AddDefaultQuantity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OnyxScheduling.Models.Invoices", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateTime = new DateTime(2024, 5, 30, 13, 46, 39, 315, DateTimeKind.Local).AddTicks(4115),
                            FinishedDateTime = new DateTime(2024, 5, 30, 13, 46, 39, 315, DateTimeKind.Local).AddTicks(4194),
                            InvoiceId = 0,
                        ...
                        new
                        {
                            ...
                            Assigned_Customer_Id = "01c84c0a-84f1-4504-94ba-ce28a4c99245",
                            Assigned_Technician_Id = "2",
                            CreatedDateTime = new DateTime(2024, 5, 30, 13, 46, 39, 315, DateTimeKind.Local).AddTicks(4204),
                            FinishedDateTime = new DateTime(2024, 5, 30, 13, 46, 39, 315, DateTimeKind.Local).AddTicks(4206),
                            InvoiceId = 0,
