...
namespace OnyxScheduling.Data.Migrations
{
    ...
    [Migration("20231208163120_ChangedSeedData")]
            ...
            modelBuilder.Entity("OnyxScheduling.Models.Invoices", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateTime = new DateTime(2023, 12, 8, 11, 31, 20, 84, DateTimeKind.Local).AddTicks(3065),
                            FinishedDateTime = new DateTime(2023, 12, 8, 11, 31, 20, 84, DateTimeKind.Local).AddTicks(3109),
                            InvoiceId = 0,
                        ...
                        new
                        {
                            ...
                            Assigned_Customer_Id = "01c84c0a-84f1-4504-94ba-ce28a4c99245",
                            Assigned_Technician_Id = "2",
                            CreatedDateTime = new DateTime(2023, 12, 8, 11, 31, 20, 84, DateTimeKind.Local).AddTicks(3112),
                            FinishedDateTime = new DateTime(2023, 12, 8, 11, 31, 20, 84, DateTimeKind.Local).AddTicks(3113),
                            InvoiceId = 0,
